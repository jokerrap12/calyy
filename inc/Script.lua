...
redis:set(clay.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(clay..'lock:join:'..msg.chat_id_,true)
...
redis:del(clay..'lock:join:'..msg.chat_id_)
return "*• ** أهلا عزيزي *"..msg.TheRankCmd.."*\n• ** تم فتح الدخول بالرابط \n*" 
end


local function iclay(msg,MsgText)

Channel = redis:get(clay..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(clay..'joinchnl') then
...
redis:set(clay.."getidstatus"..msg.chat_id_, "Photo")
redis:set(clay..'lock:kara:'..msg.chat_id_,'off')
return modadd(msg)  
end
...
redis:setex(clay..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(clay..'CheckExpire::'..msg.chat_id_) then 
redis:set(clay..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(clay..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(clay..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(clay..'CheckExpire::'..msg.chat_id_) then 
redis:set(clay..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(clay..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(clay..'CheckExpire::'..msg.chat_id_) then 
redis:set(clay..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(clay..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(clay..'CheckExpire::'..msg.chat_id_) then 
redis:set(clay..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(clay..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(clay..'group:name'..msg.chat_id_) or '')
redis:set(clay..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(clay..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. clay..'')
...
if not msg.Director and redis:get(clay..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(clay..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(clay..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(clay..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(clay..'admins:'..msg.chat_id_)
redis:del(clay..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(clay..'owners:'..msg.chat_id_)
redis:del(clay..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(clay..'whitelist:'..msg.chat_id_)
redis:del(clay..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(clay..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(clay..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(clay..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(clay..'linkGroup'..msg.sender_user_id_,300,true)
return '• عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(clay..'linkGroup'..msg.chat_id_) then 
return "• ** اوه لا يوجد رابط .\n• **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(clay..'group:name'..msg.chat_id_)
local GroupLink = redis:get(clay..'linkGroup'..msg.chat_id_)
...
local Text = "• رابـط الـمـجـمـوعه • \n"..Flter_Markdown(redis:get(clay..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(clay..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(clay..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "• ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(clay..':Filter_Word:'..msg.chat_id_)
...
redis:del(clay..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(clay..'welcome:msg'..msg.chat_id_) then 
return "• ** اوه هنالك خطأ .\n• عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(clay..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(clay..':Hussain:'..msg.chat_id_)
redis:del(clay..':Hussain:'..msg.chat_id_)
...
if not msg.Kara then return "✲¦  **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local NumMnsha = redis:scard(clay..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(clay..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(clay..'banned:'..msg.chat_id_)
if #list == 0 then return "*• لا يوجد مستخدمين محظورين  *" end
message = '• ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(clay..'banned:'..msg.chat_id_)
return "• **أهلا عزيزي "..msg.TheRankCmd.."   \n•  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(clay..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "• ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(clay..'is_silent_users:'..msg.chat_id_)
...
redis:del(clay..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "• **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(clay..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(clay..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "• **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(clay..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(clay..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(clay..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(clay..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(clay..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(clay..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(clay..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local rfih = (redis:get(clay..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(clay..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(clay.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'𖣐-𝙽𝙰𝙼𝙴↠ ↠   '..Namei..'     \n𖡦-𝚄𝚂𝙴𝚁↠ ↠ '..UserNameID..' .\n𖡨-𝙼𝚂𝙶𝙴↠ ↠ '..msgs..' .\n𖤍-𝚂𝚃𝙰↠ ↠ '..msg.TheRank..' .\n𖤓-𝙸𝙳↠ ↠ '..msg.sender_user_id_..' \n𖤓-𝙲𝙷↠ ↠ @SOURCE_ZORO .',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(clay..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(clay..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(clay..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(clay..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(clay..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(clay..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(clay..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(clay..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(clay..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(clay..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "• **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '• **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(clay..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(clay..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "• **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(clay..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(clay..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "• **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(clay..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(clay..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(clay..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(clay..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(clay..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(clay..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(clay..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(clay..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(clay..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(clay..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(clay..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(clay..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(clay..'welcome:msg'..msg.chat_id_))
else 
return "• **أهلا عزيزي "..msg.TheRankCmd.."  \n• نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(clay..'group:ids')
...
local pv = redis:smembers(clay..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(clay..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
redis:setex(clay..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '• حسننا عزيزي .\n• الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(clay..':addnumberusers',MsgText[2]) 
return '•☆ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'•☆ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(clay..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات ☆" then
if not msg.SudoUser then return "•☆ **هذا الامر يخص {المطور} فقط  \n" end
return '• ** عدد المجموعات المفعلة » `'..redis:scard(clay..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين ☆" then
if not msg.SudoUser then return "•☆ **هذا الامر يخص {المطور} فقط  \n" end
return '• **عدد المشتركين في البوت : `'..redis:scard(clay..'users')..'` \n'
end
...
if not msg.SudoUser then return "•☆ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(clay..'group:ids',MsgText[2]) then
local name_gp = redis:get(clay..'group:name'..MsgText[2])
...
return redis:get(clay..":TEXT_SUDO") or '• لا توجد كليشه المطور .\n• يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه ☆" then
if not msg.SudoUser then return"•☆ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(clay..'lock_brod') then 
return "•☆ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(clay..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(clay..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(clay..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(clay..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:del(clay..'welcom:witting'..msg.sender_user_id_,
clay..'rulse:witting'..msg.sender_user_id_,
clay..'rulse:witting'..msg.sender_user_id_,
clay..'name:witting'..msg.sender_user_id_,
clay..'about:witting'..msg.sender_user_id_,
clay..'fwd:all'..msg.sender_user_id_,
clay..'fwd:pv'..msg.sender_user_id_,
clay..'fwd:groups'..msg.sender_user_id_,
clay..'namebot:witting'..msg.sender_user_id_,
clay..'addrd_all:'..msg.sender_user_id_,
clay..'delrd:'..msg.sender_user_id_,
clay..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
clay..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
clay..'addrd:'..msg.sender_user_id_,
clay..'delrdall:'..msg.sender_user_id_,
clay..":ForceSub:"..msg.sender_user_id_,
clay..'text_sudo:witting'..msg.sender_user_id_,
clay..'addrd:'..msg.chat_id_..msg.sender_user_id_,
clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/ZOROFILE/master/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(clay..":VERSION",GetVerison)
return false
else
...
return 'ٴ𐄬 اصدار سورس زورو : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'•☆ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس زورو يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/tamer_hosni"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : زورو](https://t.me/tamer_hosni)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات ☆" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '•☆ الاحصائيات . \n\n•☆ **عدد المجموعات المفعله : '..redis:scard(clay..'group:ids')..'\n• **عدد المشتركين في البوت : '..redis:scard(clay..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ☆" then
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(clay..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "• حسننا الان ارسل كلمة الرد العام .\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(clay..'replay:'..msg.chat_id_)
local photo 	= redis:exists(clay..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(clay..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(clay..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(clay..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(clay..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(clay..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(clay..'replay:'..msg.chat_id_,clay..'replay_photo:group:'..msg.chat_id_,clay..'replay_voice:group:'..msg.chat_id_,
clay..'replay_animation:group:'..msg.chat_id_,clay..'replay_audio:group:'..msg.chat_id_,clay..'replay_sticker:group:'..msg.chat_id_,clay..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(clay..'replay:all')
local photo 	= redis:exists(clay..'replay_photo:group:')
local voice 	= redis:exists(clay..'replay_voice:group:')
local imation 	= redis:exists(clay..'replay_animation:group:')
local audio 	= redis:exists(clay..'replay_audio:group:')
local sticker 	= redis:exists(clay..'replay_sticker:group:')
local video 	= redis:exists(clay..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(clay..'replay:all',clay..'replay_photo:group:',clay..'replay_voice:group:',clay..'replay_animation:group:',clay..'replay_audio:group:',clay..'replay_sticker:group:',clay..'replay_video:group:')
...
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(clay..'delrdall:'..msg.sender_user_id_,true) 
return "•☆ حسننا عزيزي  .\n• الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "•☆ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(clay..'delrd:'..msg.sender_user_id_,true)
return "•☆ حسننا عزيزي  .\n• الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "•☆ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(clay..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(clay..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(clay..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(clay..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(clay..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(clay..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(clay..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(clay..'replay:all')
local photo 	= redis:hkeys(clay..'replay_photo:group:')
local voice 	= redis:hkeys(clay..'replay_voice:group:')
local imation 	= redis:hkeys(clay..'replay_animation:group:')
local audio 	= redis:hkeys(clay..'replay_audio:group:')
local sticker 	= redis:hkeys(clay..'replay_sticker:group:')
local video 	= redis:hkeys(clay..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '•☆ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "•☆ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(clay..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "• حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(clay..'namebot:witting'..msg.sender_user_id_,300,true)
...
✪• م5 ⬅︎ أوامر التسليه.
𑁍‌
✪• م6 ⬅︎ أوامر التعطيل او التفعيل.
𑁍‌
✪• م7 ⬅︎ أوامر الوضع للمجموعه.
𑁍‌
✪• م المطور ⬅︎  أوامر المطور.
𑁍‌
✪• أوامر الرد ⬅︎ لإضافة‌‏ رد معين.
𑁍‌
✪• الوسائط ⬅︎ لمعرفة الإعدادات.
𑁍‌
✪• الإعدادات ⬅︎ إعدادات المجموعة.
𑁍‌
✪• سورس ⬅︎لعرض كليشة سورس البوت.
𑁍‌
✪• المطور ⬅︎ لعرض كليشة مطور البوت.

𓇠—————clay——————↠
•📥للتواصل ⬅︎ ✓ ⬅︎{ ]]..SUDO_USER..[[ } ✓ ]]
end
if MsgText[1]== 'م1' then
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
local text =[[     
✪⬅︎❬أوامر الرفع والتنزيل❭
...
✯• مسح المــــدراء «» ❬لمسح المدراء❭
 𓇠———————clay—————↠
✪⬅︎❬أوامر الحظر والطرد والتقييد❭

✯• حظر ❬بالرد «» بالمعرف❭ لحظر العضو.
✯• الغاء الحظر ❬بالرد «» بالمعرف❭ لإلغاء الحظر. 
...
✯• فك التقييد ❬بالرد «» بالمعرف❭ لإلغاء تقييد العضو.
✯• منع + الكلمة «» لمنع كلمة داخل المجموعة.
✯• الغاء منع «» لالغاء منع الكلمة.
 𓇠——————clay——————↠
...
★• انشاء رابط › لإستخراج ❬الرابط❭ .
★• الادمنيه › لعرض ❬الأدمنيه❭.
★• القوانين › لعرض ❬القوانين❭ .
★• الوسائط › لعرض إعدادات ❬الميديا❭. 
★• الحمايـه › لعرض كل ❬الإعدادات❭ .
★• المــدراء › لعرض ❬المُديريين❭.
★• المكتومين › لعـرض ❬المكتومين❭.
★• المحظورين › لعرض ❬المحظورين❭.
★• الإعدادات › لعرض إعدادات❬المجموعة❭. 
★• المجموعة › لعرض معلومات❬المجموعة❭.
★• تغير امر + الامر › لتغير ❬أوامر البوت❭.
★• مسح امر + الامر › لمسح ❬الأمر المضاف❭.
★• قائمـه الاوامر › لمعرفه❬الأوامر المضافه❭.
——————clay——————↠
•✰ معـرف المـطور↤︎↤︎⬅︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
end
...
★• الرابط › لإستخراج رابط المجموعة.
★• جهاتي › لمعرفة عدد جهاتك.
★• الالعاب › لعرض العاب البوت.
★• نقاطي › لمعرفة عدد نقاطك.
...
★• كشف بالمعرف › لمعرفة معلومات حسابه.
★• كشف بالرد › لمعرفة معلومات حسابه.
★• كشف البوتات › لإظهار عدد البوتات الموجوده.
...
𓇠—————clay——————↠
✰•  للتواصل و الإستفسار ↤︎  ⬅︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
end
...
★• تفعيـل › ❬لتفعيل البوت ❭
★• تعطيل › ❬لتعطيل البوت ❭
★• رفع منشئ› ❬رفع منشئ بالبوت❭
——————clay——————
★• اذاعه › ❬لنشر رساله لكل 
المجموعات❭
𑁍
★• اذاعه خاص › ❬ لنشر رساله لكل 
المشتركين خاص❭
𑁍
...
𑁍
★• تحديث السورس › ❬لتحديث السورس الى إصدار أحدث❭
——————clay——————
✰•  معـرف المـطور ↤︎ ⬅︎ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
𑁍
★• مسح رد › الرد المُراد مسحه.
𑁍
★• مسح الردود › لمسح كل الردود.
𑁍
★• الردود العامه › لمعرفة الردود المثبته عام.
𑁍
★• اضف رد عام › لإضافة رد لكل المجموعات.
𑁍
...
if not msg.Admin then return "•☆ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
if not redis:get(clay..'lave_me'..msg.chat_id_) then 
return "•☆ **أهلا عزيزي "..msg.TheRankCmd.."\n• ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(clay..'lave_me'..msg.chat_id_) 
return "• **أهلا عزيزي "..msg.TheRankCmd.."\n• ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "•☆ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
if redis:get(clay..'lave_me'..msg.chat_id_) then 
return "•☆ **أهلا عزيزي "..msg.TheRankCmd.."\n• ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(clay..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(clay..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(clay..":UserNameChaneel")
if UserChaneel then
...
if redis:get(clay..'welc'..msg.chat_id_) == 'on' then
...
local hash = clay..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(clay..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(clay..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(clay..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'• اهلا عزيزي \n• تم تثبيت الامر الجديد\n✓')
redis:del(clay..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "•☆ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(clay..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(clay..'CmD:'..msg.chat_id_,cmd)
redis:srem(clay..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"•☆ اهلا عزيزي\nالامر >"..cmd.."\n• تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "•☆ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(clay..'CmD:'..msg.chat_id_)
redis:del(clay..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"•☆ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "•☆ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(clay..'CmDlist:'..msg.chat_id_)
local t = '• قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(clay..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(clay..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(clay..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(clay..'welc'..msg.chat_id_,'off')
redis:del(clay..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,clay)   
if clay.content_.ID == "MessageSticker" then        
local bd = clay.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(clay..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(clay..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*• * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(clay..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس زورو\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
redis:sadd(clay..'users',msg.sender_user_id_)
if redis:get(clay..'lock_service') then 
text = [[• أهلاً انا بوت   []]..redis:get(clay..':NameBot:')..[[] 🗽
☆• أختصاصي حماية المجموعات ..
☆• مـن السبام والتوجيه والتكرار والخ..
☆• لتفعيل البوت اتبع الشـروط ..
☆1- اضف البوت الى المجموعه
☆2- ارفع البوت مشرف في المجموعه
☆3- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ــــــــــــــــــــــــــــــــ☆clay☆ـــــــــــــــــــــــــ
...
☆1- اضف البوت الى المجموعه
☆2- ارفع البوت مشرف في المجموعه
☆③- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ـــــــــــــــــــــــــــــــــ𝑍𝑂𝑅𝑂ــــــــــــــــــــــــ
 • مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
end
...
local MSG_ID = (redis:get(clay.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(clay..'lock_twasel') then
...
redis:setex(clay.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(clay..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(clay..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(clay..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n• تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(clay..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه صوره للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(clay..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه بصمه صوت للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(clay..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه متحركه للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(clay..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه فيديو للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(clay..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه للصوت للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(clay..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(clay..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(clay..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(clay..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  • تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(clay..'replay_photo:group:',klma,photo_id)
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه صوره للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(clay..'replay_voice:group:',klma,voice_id)
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه بصمه صوت للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(clay..'replay_animation:group:',klma,animation_id)
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه متحركه للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(clay..'replay_video:group:',klma,video_id)
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه فيديو للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(clay..'replay_audio:group:',klma,audio_id)
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه للصوت للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(clay..'replay_sticker:group:',klma,sticker_id)
redis:del(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(clay..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(clay..":ForceSub:"..msg.sender_user_id_)
...
redis:set(clay..":UserNameChaneel",msg.text)
...
if redis:get(clay..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(clay..'namebot:witting'..msg.sender_user_id_)
redis:set(clay..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"• تم تغير اسم البوت  .\n• الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(clay..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(clay..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(clay..'replay_photo:group:',msg.text)
redis:hdel(clay..'replay_voice:group:',msg.text)
redis:hdel(clay..'replay_animation:group:',msg.text)
redis:hdel(clay..'replay_audio:group:',msg.text)
redis:hdel(clay..'replay_sticker:group:',msg.text)
redis:hdel(clay..'replay_video:group:',msg.text)
redis:setex(clay..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• جيد , يمكنك الان ارسال جوا ب الردالعام \n• [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(clay..'delrdall:'..msg.sender_user_id_) then
redis:del(clay..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(clay..'replay:all',msg.text)
local photo =redis:hget(clay..'replay_photo:group:',msg.text)
local voice = redis:hget(clay..'replay_voice:group:',msg.text)
local animation = redis:hget(clay..'replay_animation:group:',msg.text)
local audio = redis:hget(clay..'replay_audio:group:',msg.text)
local sticker = redis:hget(clay..'replay_sticker:group:',msg.text)
local video = redis:hget(clay..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'• **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(clay..'replay:all',msg.text)
redis:hdel(clay..'replay_photo:group:',msg.text)
redis:hdel(clay..'replay_voice:group:',msg.text)
redis:hdel(clay..'replay_audio:group:',msg.text)
redis:hdel(clay..'replay_animation:group:',msg.text)
...
if redis:get(clay..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(clay..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(clay..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "• ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(clay..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(clay..'welcom:witting'..msg.sender_user_id_) 
redis:set(clay..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(clay..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(clay..'rulse:witting'..msg.sender_user_id_) 
redis:set(clay..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'• ** مرحبآ عزيزي\n• تم حفظ القوانين بنجاح .\n• ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(clay..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(clay..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(clay..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(clay..'linkGroup'..msg.sender_user_id_,link) 
redis:set(clay..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'• تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(clay..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(clay..'about:witting'..msg.sender_user_id_) 
...
if redis:get(clay..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(clay..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(clay..'users')  
local groups = redis:smembers(clay..'group:ids')
...
if redis:get(clay..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(clay..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(clay..'users')
if #pv >= 300 then
...
if redis:get(clay..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(clay..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(clay..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(clay..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(clay..':WELCOME_BOT'),[[•أهلاً انا بوت ]]..redis:get(clay..':NameBot:')..[[
• أختصاصي حماية‌‏ المجموعات
• مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(clay..'fwd:'..msg.sender_user_id_) then
redis:del(clay..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(clay..'users')
local groups = redis:smembers(clay..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(clay..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(clay..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(clay..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'• تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(clay..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(clay..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(clay..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(clay..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(clay..'replay:'..msg.chat_id_,msg.text)
redis:hdel(clay..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(clay..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(clay..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(clay..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(clay..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(clay..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(clay..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• جيد , يمكنك الان ارسال جواب الرد \n• [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(clay..'delrd:'..msg.sender_user_id_) then
redis:del(clay..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(clay..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(clay..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(clay..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(clay..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(clay..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(clay..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(clay..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'• **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(clay..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(clay..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(clay..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(clay..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(clay..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(clay..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(clay..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(clay..'welcome:msg'..msg.chat_id_) or "• اهلاً عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(clay..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(clay..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(clay..'welcome:msg'..msg.chat_id_) or "• اهلن بك عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(clay..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(clay..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(clay..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(clay..'welcome:get'..msg.chat_id_)
end
redis:setex(clay..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(clay..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(clay..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_zoro = (redis:get(clay..'num_msg_zoro'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_zoro) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(clay..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"• العضو » "..USERNAME.."\n• قمـت بتكرار اكثر مـن "..NUM_MSG_zoro.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(clay..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(clay..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(clay..'lock_woring'..msg.chat_id_) and not redis:get(clay..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(clay..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(clay..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(clay..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'• ** لا يمكنني مسح الرساله المخالفه .\n• ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(clay..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(clay..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(clay..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(clay..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(clay..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(clay..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(clay..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(clay..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(clay..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(clay..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(clay..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(clay..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(clay..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(clay..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(clay..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(clay..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(clay..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(clay..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(clay..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(clay..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(clay..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(clay..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(clay..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(clay..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(clay..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(clay..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(clay..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(clay..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(clay..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(clay..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(clay..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(clay..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(clay..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(clay..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(clay..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "هروين" or Text== "هروينه" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ♕](https://t.me/mhzon1)")
elseif Text== "باندا" or Text== "علي باندا" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/uu_ban)")
elseif Text== "جوكر" or Text== "جوكر راب" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ♕](https://t.me/jokerrap2)")
elseif Text== "النمرود" or Text== "نمرود" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/H_S_A_7)")
elseif Text== "ادهم" or Text== "adham" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ♕](https://t.me/Q_Y_4)")
...
ٴ≪━━━━━clay━━━━━≫ٴ
 ...
 ✸ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "جوكر" or Text== " جوكر راب " or Text=="joker rap" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/jokerrap2) ")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..clay..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(clay..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(clay..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(clay..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(clay..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(clay..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(clay..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(clay..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(clay..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(clay..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'• انتهى الاشتراك في احد المجموعات .\n• المجموعه : '..FlterName(redis:get(clay..'group:name'..msg.chat_id_))..'.\n• ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'• انتهى الاشتراك البوت.\n• سوف اغادر المجموعه فرصه سعيده .\n• او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(clay..'ExpireDate:'..msg.chat_id_) / 86400)
